// =========================================================
// 9. main.js - CORE LOGIC (V11: FINAL ERROR-FREE MASTER CODE)
// Ensures compatibility with the existing Firebase Index setup by aligning all queries to ASC.
// =========================================================
...
async function loadPoemFeed(searchQuery = '') {
    ...
    try {
        ...
        // Displaying a simple failure message after all fixes
        poemFeedContainer.innerHTML = `<p class="error-message status-error" style="grid-column: 1 / -1; text-align: center;">கவிதைகளைப் பெறுவதில் சிக்கல். (Rules/Index பிழை)</p>`;
    }
}
