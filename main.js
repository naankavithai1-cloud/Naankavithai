// =========================================================
// 9. main.js - CORE LOGIC (V5: Login Button Fix & Auth State Reading)
// =========================================================
...
// =========================================================
// 4. AUTHENTICATION LOGIC (CRITICAL FIX: Setting isAdmin flag)
// =========================================================
...
async function signInWithGoogle() {
    ...
    try {
        ...
        // Step 1: Save details including isAdmin flag
        await saveAtomicUserDetails(result.user);
        // Step 2: Reload the page to ensure all components recognize the new Auth State and Admin flag
...
async function saveAtomicUserDetails(user) {
    ...
    const userDetails = {
        ...
        // CRITICAL FIX: Set isAdmin field in Firestore for Security Rules
        isAdmin: isOwner, 
    };
...
onAuthStateChanged(auth, (user) => {
    ...
    if (user) {
        ...
        // This attempts to update/save user details every time the auth state is read
...
// =========================================================
// 5. CLOUDINARY & POEM SUBMISSION LOGIC (No major change)
// =========================================================

async function uploadImageToCloudinary(file) {
    // ... (Code for uploading to Cloudinary)
    if (!file) return null;
...
// =========================================================
// 6. REAL-TIME FEED & PWA LOGIC (No change)
// =========================================================
