// =========================================================
// 9. main.js - CORE LOGIC (V10: FINAL MASTER CODE FOR DEPLOYMENT)
// Ensures compatibility with the existing Firebase Index setup.
// =========================================================
...
// =========================================================
// 4. AUTHENTICATION LOGIC (Finalized)
// =========================================================
...
// =========================================================
// 5. POEM SUBMISSION LOGIC (Finalized)
// =========================================================
...
// =========================================================
// 6. REAL-TIME FEED & SEARCH/FILTER LOGIC (FINALIZED)
// =========================================================
...
async function loadPoemFeed(searchQuery = '') {
    ...
    if (currentSortOrder === 'latest') {
        // FINAL FIX: Using DESCENDING order which requires the correct Index (status ASC, createdAt DESC)
    ...
    // 2. Apply Search Filter if query is provided
    if (searchQuery) {
    ...
    try {
        ...
        // Display generic error message to the user, confirming the Index/Rules is the issue.
        poemFeedContainer.innerHTML = `<p class="error-message status-error" style="grid-column: 1 / -1; text-align: center;">கவிதைகளைப் பெறுவதில் சிக்கல். (Index/Rules பிழை)</p>`;
    }
}
