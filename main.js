// =========================================================
// 9. main.js - CORE LOGIC (V14: FINAL ERROR-FREE SEARCH FIX)
// =========================================================
...
// =========================================================
// 6. REAL-TIME FEED & SEARCH/FILTER LOGIC (FINAL FIX)
// =========================================================
...
async function loadPoemFeed(searchQuery = '') {
    ...
    // 2. Apply Search Filter ONLY IF query is NOT empty (CRITICAL)
    if (searchQuery) {
    ...
    try {
        ...
        // Displaying the error to the user to confirm the failure point
