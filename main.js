...
async function signInWithGoogle() {
    ...
    try {
        ...
        // Ensure page reloads after successful sign-in
...
async function loadPoemFeed(searchQuery = '') {
    ...
    if (currentSortOrder === 'latest') {
        // FINAL FIX: Using DESCENDING order which requires a specific Index (status ASC, createdAt DESC)
    ...
    if (searchQuery) {
        ...
        // NOTE: This requires a separate Index on 'title'.
        q = query(q, 
    ...
    try {
        ...
        // This final error message is shown only if the Index/Rules are mismatched.
